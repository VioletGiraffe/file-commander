...
live in `plugins/viewer/csvviewer/tests/`. `core-tests/test-utils/` holds the shared helpers: temporary folder
generation, random data, link creation, Qt/Catch2 glue. The project files are authoritative for the current test set.
