	...
	_findDialog(this, "Plugins/TextViewer/Find/")
{
	...
	const auto spaceWidth = _textBrowser.fontMetrics().horizontalAdvance(' ');
	_textBrowser.setTabStopDistance(static_cast<qreal>(4 * _textBrowser.fontMetrics().boundingRect(' ').width()));
